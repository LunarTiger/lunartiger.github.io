document.body.insertAdjacentHTML('afterbegin',`<p style="font-size:65%;color:#333;">&#9913;mirror&#9913;</p>`)
document.head.insertAdjacentHTML('beforeend',`<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=RyQA5rLO48">
...
<link rel="manifest" href="/fs-mirror/site.webmanifest?v=RyQA5rLO48">
