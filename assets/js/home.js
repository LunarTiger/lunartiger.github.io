...
id.on('value', (function(snapshot) {
	...
	if(idVal && !!document.getElementById('musicembed')){
		document.getElementById('musicembed').style = "max-width:100%;height:197px;width:350px;border: 0px";
		document.getElementById('musicembed').src = "https://www.youtube-nocookie.com/embed/"+idVal+"?rel=0;&autoplay=0";
	}
	if(!idVal && !!document.getElementById('musicembed')){
...
message.on('value', (function(snapshot) {
	...
	if(messageVal && !!document.getElementById('messageembed')){
